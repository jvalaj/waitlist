...
html = html.replace(
    ...
    `<h2 class="chapter-title highlight-text">App blockers and screen time limits don't work. And you know it.</h2>`
);
...
html = html.replace(
    ...
    `<p class="chapter-body highlight-text">Most screen-time apps treat you like a child. They throw up angry red lock screens, enforce password gates, and lecture you about how social media is "evil." But forcefully restricting your phone doesn't work. It triggers two major psychological traps:</p>`
);
